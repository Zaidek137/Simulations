...
>) {
  ...
  params.append('sdkMetadata', JSON.stringify({ name: 'interactive-universe-map', version: '0.1.0' }));

  return `${CROSSMINT_BASE_URLS[environment]}sdk/2024-03-05/hosted-checkout?${params.toString()}`;
}
