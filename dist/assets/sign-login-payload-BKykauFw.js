function $(e){let s=[`${e.domain} wants you to sign in with your Ethereum account:`,e.address].join(`
...
`));const h=n.join(`
`);return[s,h].join(`
`)}async function d(e){const{payload:t,account:r}=e,s=await r.signMessage({message:$(t)});return{payload:t,signature:s}}export{d as signLoginPayload};
//# sourceMappingURL=sign-login-payload-BKykauFw.js.map
